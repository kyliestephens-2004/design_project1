...
| ------------------------------------- | ------- | ------------------------------------------------------------ | ---------------------- |
| ProjectName                           | String  | Name of the archaeological project/site                      | Stewart Castle Village |
| ProjectID                             | Integer | Unique identifier for the project                            | 1210                   |
| Context                               | String  | Specific excavation context identifier                       | 001A                   |
| DepositType                           | String  | Type of deposit where artifacts were found                   | Topsoil                |
| UnitType                              | String  | Type of excavation unit                                      | Quadrat/Unit           |
| FeatureType                           | Float   | Type of feature associated with the artifact (if applicable) | NaN                    |
| FeatureNumber                         | Float   | Identifier for the feature                                   | NaN                    |
| FeatureGroup                          | Float   | Grouping of related features                                 | NaN                    |
| FeatureGroupInterpretation            | Float   | Interpretation of the feature group                          | NaN                    |
| DAACSStratigraphicGroup               | Float   | Stratigraphic grouping in the DAACS system                   | NaN                    |
| DAACSStratigraphicGroupInterpretation | Float   | Interpretation of stratigraphic grouping                     | NaN                    |
| DAACSPhase                            | String  | Phase designation in the DAACS classification                | P02                    |
| Count                                 | Integer | Number of artifacts in the grouped record                    | 12                     |
| ArtifactType                          | String  | Specific type of artifact                                    | Pearlware              |
| ArtifactCategory                      | String  | General category of artifact                                 | Ceramic                |
